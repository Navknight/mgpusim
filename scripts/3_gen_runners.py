...
for config in configs:
    for benchmark in benchmarks:
        ...
        if benchmark == 'aes':
            ...
            submit_file.write("-length=5242880 ")
            ...
            submit_file.write("-points=52428 -features=32 -clusters=20 ")
            ...
            submit_file.write("-x=2048 -y=2048 -z=2048 ")
            submit_file.write("-unified-gpus=1,2,3,4 ")
            # submit_file.write("-gpus=1,2,3,4 ")
            ...
            submit_file.write("-dim=2097152 -sparsity=0.0001 ")
